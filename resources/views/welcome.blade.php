    ...
    <div class="lg:min-h-[560px] bg-blue-100 px-4 sm:px-10">
      <div class="max-w-7xl w-full mx-auto py-16">
        <div class="grid lg:grid-cols-2 justify-center items-center gap-10">
          <div>
            <h1 class="md:text-5xl text-4xl font-bold mb-6 md:!leading-[55px]">Welcome to Rentify
            </h1>
            <p class="text-base leading-relaxed">Rentify is a comprehensive platform that connects landlord and tenants,
          ...
          <div class="max-lg:mt-12 h-full">
            <img src="https://i.postimg.cc/cCzFTpTc/rentify-logo-2.png" alt="Rentify Logo" class="w-full h-full object-cover" 
            style="width: 600px; height: auto; margin-top: 40px;"/>
          </div>
        </div>
      </div>
    </div>
